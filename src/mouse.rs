...
mod tests {
    ...
    fn test_encode_mouse_button() {
        let cases: &[(&str, MouseButton, bool, bool, bool, bool, u8)] = &[
            ("mouse release", MOUSE_NONE, false, false, false, false, 0b0000_0011),
            ("mouse release with ctrl", MOUSE_NONE, false, false, false, true, 0b0001_0011),
            ("mouse left", MOUSE_LEFT, false, false, false, false, 0b0000_0000),
            ("mouse right", MOUSE_RIGHT, false, false, false, false, 0b0000_0010),
            ("mouse wheel up", MOUSE_WHEEL_UP, false, false, false, false, 0b0100_0000),
            ("mouse wheel right", MOUSE_WHEEL_RIGHT, false, false, false, false, 0b0100_0011),
            ("mouse backward", MOUSE_BACKWARD, false, false, false, false, 0b1000_0000),
            ("mouse forward", MOUSE_FORWARD, false, false, false, false, 0b1000_0001),
            ("mouse button 10", MOUSE_BUTTON_10, false, false, false, false, 0b1000_0010),
            ("mouse button 11", MOUSE_BUTTON_11, false, false, false, false, 0b1000_0011),
            ("mouse middle with motion", MOUSE_MIDDLE, true, false, false, false, 0b0010_0001),
            ("mouse middle with shift", MOUSE_MIDDLE, false, true, false, false, 0b0000_0101),
            ("mouse middle with motion and alt", MOUSE_MIDDLE, true, false, true, false, 0b0010_1001),
            ("mouse right with shift, alt, and ctrl", MOUSE_RIGHT, false, true, true, true, 0b0001_1110),
            ("mouse button 10 with motion, shift, alt, and ctrl", MOUSE_BUTTON_10, true, true, true, true, 0b1011_1110),
            ("mouse left with motion, shift, and ctrl", MOUSE_LEFT, true, true, false, true, 0b0011_0100),
            ("invalid mouse button", MouseButton(0xff), false, false, false, false, 0b1111_1111),
            ("mouse wheel down with motion", MOUSE_WHEEL_DOWN, true, false, false, false, 0b0110_0001),
            ("mouse wheel down with shift and ctrl", MOUSE_WHEEL_DOWN, false, true, false, true, 0b0101_0101),
            ("mouse wheel left with alt", MOUSE_WHEEL_LEFT, false, false, true, false, 0b0100_1010),
            ("mouse middle with all modifiers", MOUSE_MIDDLE, true, true, true, true, 0b0011_1101),
        ];
    ...
    fn test_mouse_sgr() {
        let cases: &[(&str, MouseButton, i32, i32, bool)] = &[
            ...
            ("mouse right with shift, alt, and ctrl", MOUSE_RIGHT, 10, 1, false),
            ("mouse release", MOUSE_NONE, 5, 5, true),
            ("mouse button 10 with motion, shift, alt, and ctrl", MOUSE_BUTTON_10, 10, 10, false),
            ("mouse wheel up with motion", MOUSE_WHEEL_UP, 15, 15, false),
            ("mouse middle with all modifiers", MOUSE_MIDDLE, 20, 20, false),
            ("mouse wheel left at max coordinates", MOUSE_WHEEL_LEFT, 223, 223, false),
            ("mouse forward release", MOUSE_FORWARD, 100, 100, true),
            ("mouse backward with shift and ctrl", MOUSE_BACKWARD, 50, 50, false),
        ];
